...
- React Query key/options/invalidate 상세는 `guides/my-console-query-mutation-spec.md`를 사용한다.
...
- 페이지 상태 머신은 `guides/my-console-page-state-machine-spec.md`를 사용한다.
- 접근성 체크는 `guides/my-console-accessibility-checklist.md`를 사용한다.
- 페이지별 acceptance checklist는 `guides/my-console-page-acceptance-checklist.md`를 사용한다.
